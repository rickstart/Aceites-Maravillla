...
(function ($) {
	...
	$.widget("thomaskahn.smoothDivScroll", {
		...
		options: {
			...
			manualContinuousScrolling: true, // ++false++ Boolean

			// Autoscrolling
			autoScrollingMode: "", // always, onStart or empty (no auto scrolling) String
			autoScrollingDirection: "right", // right, left, backAndForth, endlessLoopRight, endlessLoopLeft String
			autoScrollingStep: 1, // Pixels
			autoScrollingInterval: 10, // Milliseconds

			// Touch scrolling
			touchScrolling: true, //false
